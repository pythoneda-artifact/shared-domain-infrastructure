...
"""
pythoneda/artifact/shared/domain/infrastructure/dbus/domain_artifact_dbus_signal_emitter.py
...
class DomainArtifactDbusSignalEmitter(ArtifactDbusSignalEmitter):

    """
    A Port that emits events generated by Domain-Artifact as d-bus signals.

    Class name: DomainArtifactDbusSignalEmitter
    ...
    def __init__(self):
        """
        Creates a new DomainArtifactDbusSignalEmitter instance.
        """
        super().__init__()
